/*
	This package is a small library for converting a struct to a map for easy iteration with for/range.

Thanks to Klathmon :)
https://pkg.go.dev/github.com/Klathmon/StructToMap
https://github.com/Klathmon/StructToMap
*/
package structs
